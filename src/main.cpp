...
int main(){
    ...
    cShader simulation("comp_shaders/evolution_one.glsl", gridX, gridY);
    simulation.compile_shader();

    cShader simulation_two("comp_shaders/evolution_two.glsl", gridX, gridY);
    simulation_two.compile_shader();
